...
let Main = {
    ...
    methods: {
        ...
        to_manage_models:function(){
            window.open('/jxzz_2/model_manage/');
        },
        // 加载遮罩
                    ...
                    this.$prompt('输入预览场景的名称', '预览设置', {
                        ...
                        this.$http.post(
                            ...
                            { emulateJSON: true }
                                ...
                                if(res.body=="success"){
                                    window.open('/jxzz_2/view_display/'+this.display_view_id);
                                }    
                        });                        
                      }).catch(() => {
                        this.$message({
        ...
        view_program:function() {
            ...
            temp_form.action = '/jxzz_2/view_program_page/';
